    ...
    <CoursesContainer id="course">
      ...
      <CoursesWrapper>
        <CoursesCard>
          ...
          <CoursesP>
            Learn basic computer skills such as word processing software,
            spreadsheet software, Email management, Data entry etc
          </CoursesP>
        </CoursesCard>
        <CoursesCard>
          ...
          <CoursesP>
            You will learn HTML, CSS and programming language such as
            Javascript, Nodejs etc and Javascript Libraries such as React
          </CoursesP>
        </CoursesCard>
        <CoursesCard>
          ...
          <CoursesP>
            In our Data science class you will get to learn Spreadsheet in
            detail, SQL, Python programming language
          </CoursesP>
        </CoursesCard>
      </CoursesWrapper>
    </CoursesContainer>
